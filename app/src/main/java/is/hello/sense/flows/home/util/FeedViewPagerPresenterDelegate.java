...
public class FeedViewPagerPresenterDelegate extends BaseViewPagerPresenterDelegate {
    private final Resources resources;

    public FeedViewPagerPresenterDelegate(@NonNull final Resources resources) {
