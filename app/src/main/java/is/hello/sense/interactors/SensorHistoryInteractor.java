...
public class SensorHistoryInteractor extends ValueInteractor<ArrayList<SensorGraphSample>> {
    @Inject ApiService apiService;

    private String sensorName;
    private Mode mode = Mode.DAY;

    public final InteractorSubject<ArrayList<SensorGraphSample>> history = this.subject;
