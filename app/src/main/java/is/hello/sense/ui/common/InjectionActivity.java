...
public abstract class InjectionActivity extends SenseActivity implements ObservableContainer, AnimatorContext.Scene {
    ...
    protected @Nullable AnimatorContext animatorContext = null;
