...
public class TabsBackgroundDrawable extends SelectorView.SelectionAwareDrawable {
    ...
    public enum Style {
        BACKSIDE(R.dimen.bottom_line, R.dimen.bottom_line, R.color.tabs_background_selected, R.color.border_backside_tabs, R.color.background_light),
        INLINE(R.dimen.bottom_line, R.dimen.divider_size, R.color.tabs_background_selected, R.color.border, R.color.background_light),
        SUBNAV(R.dimen.bottom_line, R.dimen.x3, R.color.background_light, R.color.background_light, R.color.background_light);
