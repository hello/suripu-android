...
/**
 * View to show a graphs Bar type.
 */
public class BarTrendGraphView extends TrendGraphView {
    ...
    public class BarGraphDrawable extends TrendGraphDrawable {
        ...
        public BarGraphDrawable(@NonNull final Context context,
            ...
            Drawing.updateTextPaintFromStyle(highlightTextPaint, context, R.style.Trends_BarGraph_HighLight);
        ...
        public void draw(Canvas canvas) {
            ...
            for (int i = 0; i < sections.size(); i++) {
                ...
                for (int j = 0; j < values.size(); j++) {
                    ...
                    if (Float.isNaN(scaledRatio) || Float.isInfinite(scaledRatio)) {
                        scaledRatio = 1f;
                    }
