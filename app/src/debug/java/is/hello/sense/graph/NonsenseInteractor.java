...
public class NonsenseInteractor extends Interactor implements NsdManager.DiscoveryListener {
    ...
    public final InteractorSubject<List<? extends ApiEndpoint>> endpoints = InteractorSubject.create();

    @Inject
    public NonsenseInteractor(@NonNull Context context) {
