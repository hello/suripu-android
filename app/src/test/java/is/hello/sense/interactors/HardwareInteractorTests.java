...
public class HardwareInteractorTests extends InjectionTestCase {
    @Inject
    HardwareInteractor presenter;
    ...
    private static <T> void assertThrowsNoDeviceError(@NonNull Observable<T> observable) {
        try {
            ...
            fail("Expected " + HardwareInteractor.NoConnectedPeripheralException.class.getCanonicalName());
        } catch (Exception e) {
            assertThat(e, is(instanceOf(HardwareInteractor.NoConnectedPeripheralException.class)));
        }
    }
}
