...
public class SenseVoicePresenterTests extends InjectionTestCase{
    @Inject
    ...
    public void getMostRecent() {
        ...
        final VoiceResponse returnedResponse = SenseVoicePresenter.getMostRecent(
    ...
    public void getNullResponse(){
        final VoiceResponse returnedResponse = SenseVoicePresenter.getMostRecent(new ArrayList<>(0));
    ...
    public void hasSuccessfulTrue(){
        assertTrue(SenseVoicePresenter.hasSuccessful(new VoiceResponse(DEFAULT_DATE_TIME, null, null, null, VoiceResponse.Result.OK)));
    }

    @Test
    public void hasSuccessfulFalse(){
        assertFalse(SenseVoicePresenter.hasSuccessful(new VoiceResponse(DEFAULT_DATE_TIME, null, null, null, VoiceResponse.Result.REJECTED)));
        assertFalse(SenseVoicePresenter.hasSuccessful(new VoiceResponse(DEFAULT_DATE_TIME, null, null, null, VoiceResponse.Result.UNKNOWN)));
        assertFalse(SenseVoicePresenter.hasSuccessful(new VoiceResponse(DEFAULT_DATE_TIME, null, null, null, VoiceResponse.Result.TRY_AGAIN)));
        assertFalse(SenseVoicePresenter.hasSuccessful(new VoiceResponse(DEFAULT_DATE_TIME, null, null, null, VoiceResponse.Result.NONE)));
    }
