...
public class UnreadStatePresenterTests extends InjectionTestCase {
    @Inject PreferencesPresenter preferences;

    private ApiService apiService;
    private UnreadStatePresenter unreadStatePresenter;
    ...
    public void setUp() {
        ...
        this.unreadStatePresenter = new UnreadStatePresenter(apiService, preferences);
    }
    ...
    public void updatesPreferences() {
        ...
        assertThat(preferences.getBoolean(PreferencesPresenter.HAS_UNREAD_INSIGHT_ITEMS, true),
                   is(false));
